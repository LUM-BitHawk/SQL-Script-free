/*
-- Determine Custom diagnostic query									                                                                                  
-- Firma: BitHawk AG
-- Script Name: Custom_diagnostic_queryns.sql
-- Description: Here's a query that combines data from multiple views.
-- It provides a more thorough overview of sessions and their status via sys.dm_exec_requests and sys.dm_exec_query_memory_grants,
